...
gra3 <- ggplot(Base_final,aes(x=factor(Lugar_nacimiento),y=Num_hijos,fill=factor(Lugar_nacimiento)))+
  geom_boxplot()+
  xlab("Lugar de nacimiento del jefe del hogar")+ylab("Número de hijos") +
  labs(fill = "Lugar de nacimiento") +
  scale_fill_brewer(labels = c("1 En este municipio", "2 En otro municipio", "3 En otro país"))
...
gra4 <- ggplot(Base_final,aes(x=factor(Vive_hogar_padre),y=Num_hijos,fill=factor(Vive_hogar_padre)))+
  ...
  labs(fill = "Vive con el padre") +
  scale_fill_brewer(labels = c("1 Si", "2 No", "3 Fallecido"))
...
gra6 <- ggplot(Base_final,aes(x=factor(Vive_hogar_madre),y=Num_hijos,fill=factor(Vive_hogar_madre)))+
  ...
  labs(fill = "Vive con la madre") +
  scale_fill_brewer(labels = c("1 Si", "2 No", "3 Fallecida"))
...
gra11 <- ggplot(Base_final,aes(x=factor(Tipo_vivienda),y=Num_hijos,fill=factor(Tipo_vivienda)))+
  ...
  scale_fill_brewer(labels = c("1 Casa", "2 Apartamento", "3 Cuarto(s)", "4 Vivienda tradicional
  indigena", "5 Otro"))
...
gra18 <- ggplot(Base_final,aes(x=factor(Nivel_educativo),y=Num_hijos,fill=factor(Nivel_educativo)))+
  ...
  labs("Nivel educativo") +
   scale_fill_brewer(labels = c("1 Ninguno", "2 Preescolar", "3 Básica Primaria
...
gra22 <- ggplot(Base_final,aes(x=factor(Uso_celular),y=Num_hijos,fill=factor(Uso_celular)))+
  ...
  labs(fill = "Uso del celular") +
   scale_fill_brewer(labels = c("1 Todos los días de la semana",
...
```{r, echo=F}
grid.arrange(puntos1, puntos2, puntos3, puntos4, nrow = 2,ncol = 2)
```
