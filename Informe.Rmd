...
Las variables categoricas de Base_interesante se convierten a factor y se crea un modelo de regresión lineal multiple para poder utilizar seleccion por pasos
...
Para la preseleccion de variables tambien se utilizaron métodos de selección de variables tales como Selección por pasos y Lasso.
...
### Seleccion de las variables de interes con lasso

Se toma la Base_final que posee 32 variables y se convierten las variables categoricas a factor.
