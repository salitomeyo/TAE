...
```{r}
Base_final[,c("ï..DIRECTORIO", "SECUENCIA_P")] <- NULL
```
...
c("Num_integrantes", "Num_cuartos", "Estrato", "Material_pisos", "Tipo_vivienda", "Num_Subsidios", "Educacion_madre", "Estado_civil")
```
