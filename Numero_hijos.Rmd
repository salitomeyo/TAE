...
Filtramos a los hijos si tienen una relación de hijo/hija o nieto/nieta con el jefe y contamos al numero de hijos por hogar, los hogares se describen con el codigo unico de ï..DIRECTORIO, SECUENCIA_P
...
```{r}
CondicionesDeVida<- read.table("Condiciones de vida del hogar y tenencia de bienes (programas).csv", sep = ";", header = T)
```

```{r}
CondicionesDeVida<-CondicionesDeVida[,c("ï..DIRECTORIO","SECUENCIA_P","ORDEN","P784S4A3")]
```
